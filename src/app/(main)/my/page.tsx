...
import { Package, RefreshCw, ChevronRight, Target, Calendar, Heart, Coins, Ticket, MapPin, Bell, Star, MessageCircleQuestion } from 'lucide-react'
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="font-semibold text-ink text-sm">1:1 문의</p>
                <p className="text-xs text-ink-5 mt-0.5">궁금한 점을 물어보세요</p>
              </div>
            </div>
            <ChevronRight size={14} className="text-ink-5 group-hover:text-[#2d7a4f] transition-colors" />
          </Link>
