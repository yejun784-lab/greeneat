...
export const metadata: Metadata = {
  ...
  description: '신선한 재료로 만드는 건강한 한 끼. GreenEat 밀키트를 구독하고 매일 특별한 식사를 즐겨보세요.',
  openGraph: {
    title: 'GreenEat — 건강한 밀키트 구독 서비스',
    description: '신선한 재료로 만드는 건강한 한 끼. GreenEat 밀키트를 구독하고 매일 특별한 식사를 즐겨보세요.',
    type: 'website',
...
const CATEGORIES = [
  { slug: 'korean', name: '한식', emoji: '🍲', desc: '정통 한국 가정식' },
  { slug: 'western', name: '양식', emoji: '🍝', desc: '간편 서양 요리' },
  { slug: 'salad', name: '샐러드', emoji: '🥗', desc: '신선한 건강식' },
  { slug: 'vegan', name: '비건', emoji: '🌿', desc: '채소 중심 식단' },
]
    ...
    <div>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-green-100 text-lg mb-8 leading-relaxed">
              신선한 재료와 검증된 레시피로<br />집에서도 레스토랑 퀄리티를 경험하세요.
            </p>
            ...
            <div className="flex gap-8 mt-10">
              {[['12+', '다양한 메뉴'], ['주 3회', '정기 배송'], ['100%', '신선 재료']].map(([num, label]) => (
                <div key={label}>
          ...
          <div className="hidden md:block">
            <div className="relative w-full aspect-square max-w-md mx-auto">
              <div className="absolute inset-4 rounded-3xl overflow-hidden shadow-2xl">
                <Image
                  src="https://images.unsplash.com/photo-1504674900247-0877df9cc836?auto=format&w=800&q=80"
                  alt="건강한 밀키트"
                  fill
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-end justify-between mb-8">
            <div>
              <h2 className="text-2xl font-bold text-ink">인기 밀키트</h2>
      ...
      <section className="bg-[#1a4a2e] py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl font-bold text-white mb-4">구독하고 더 저렴하게</h2>
          <p className="text-green-200 text-lg mb-8">
            정기 구독 시 최대 20% 할인 + 무료 배송 혜택
          </p>
          <div className="grid md:grid-cols-3 gap-4 mb-10">
            {[
              { plan: '베이직', price: '39,900', meals: '주 2회', discount: '10%' },
              { plan: '스탠다드', price: '69,900', meals: '주 4회', discount: '15%', popular: true },
              { plan: '프리미엄', price: '99,900', meals: '주 6회', discount: '20%' },
            ].map((p) => (
              <div
                key={p.plan}
