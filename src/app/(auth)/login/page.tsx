      ...
      <div className="w-full max-w-sm bg-surface rounded-2xl shadow-sm border border-line p-8">
        ...
        <div className="space-y-2 mb-5">
          ...
          <button
            ...
            disabled={!!oauthLoading}
            className="w-full flex items-center justify-center gap-2.5 py-2.5 px-4 rounded-xl text-sm font-medium bg-surface border border-line-2 text-ink hover:bg-wash transition-colors disabled:opacity-60"
          >
            <GoogleIcon />
        ...
        <div className="flex items-center gap-3 mb-5">
          ...
          <span className="text-xs text-ink-5">또는 이메일로 로그인</span>
          <div className="flex-1 h-px bg-line-2" />
        </div>
